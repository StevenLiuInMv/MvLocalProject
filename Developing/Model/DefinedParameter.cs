...
namespace MvLocalProject.Model
{
    public sealed class GlobalConstant
    {
        ...
        public static readonly string[] MvRdPcHostName = new string[] { "PC-00329", "PC-00393", "PC-00379", "PC-00348", "PC-00268", "PC-00480" };
        public static readonly string[] MvCsrPcHostName = new string[] { "PC-00226", "PC-00250", "PC-00499" };
