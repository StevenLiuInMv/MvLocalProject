...
{
    public sealed class DefinedParameter
    {
        ...
        public static readonly string[] MvMcPcHostName = new string[] { "PC-00255", "PC-00268" };
        public static readonly string[] MvRdPcHostName = new string[] { "PC-00005", "PC-00268" };
