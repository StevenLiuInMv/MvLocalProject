...
namespace MvLocalProject.Model
{
    public sealed class GlobalConstant
    {
        ...
        public static readonly string[] MvMcPcHostName = new string[] { "PC-00255", "PC-00268-" ,"MV-TFG-C01", "MV-TEST-V02"};
        public static readonly string[] MvRdPcHostName = new string[] { "PC-00329", "PC-00268", "PC-00287" ,"MV-TEST-V02"};
